    ...
    const experiences = [
        {
            ...
            description: "Designing simple interfaces and layouts and currently improve my understanding of user experience and visual design.",
        },
        {
            title: "Web Development",
            description: "Learning the fundamentals of web development including HTML, CSS, and basic programming concepts.",
        },
        {
            title: "System Analysis Practice",
            description: "School Activity Practiced analyzing simple systems and understanding how technology supports different types of businesses.",
        },
    ];
